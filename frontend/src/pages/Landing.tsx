...
const SITE_URL = "https://queuesense-saxs-14s-projects.vercel.app";
const TITLE = "QueueSense — AI Queue & Wait-Time Monitoring";
const DESCRIPTION =
  "Camera in, waiting-time estimate out. Anonymous people counting for clinics, banks, and government offices.";

const JSON_LD = {"@context": "https://schema.org", "@type": "SoftwareApplication", "name": "QueueSense", "applicationCategory": "BusinessApplication", "operatingSystem": "Web", "description": "Camera in, waiting-time estimate out. Anonymous people counting for clinics, banks, and government offices.", "url": "https://queuesense-saxs-14s-projects.vercel.app", "offers": {"@type": "Offer", "price": "0", "priceCurrency": "USD"}};
